...
_Variant:_ the same `tx_hash` with a different `log_index` is a **different** transfer and
...
_Property-test variant:_ generate random valid operation sequences and assert the property
